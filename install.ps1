...
$choice = $Host.UI.PromptForChoice('', "`nTambien quieres instalar Spicetify Marketplace? Estara disponible en el cliente de Spotify, donde podrás instalar facilmente temas y extensiones.", $choices, 0)
if ($choice -eq 1) {
